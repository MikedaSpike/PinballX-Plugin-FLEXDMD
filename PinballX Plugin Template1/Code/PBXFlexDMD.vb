            ...
            Try
                ...
                Select Case LCase(IO.Path.GetExtension(path))
                    Case ".png"
                        ...
                        objFlexDMDScene.GetImage("Image").Width = 128 'if release maybe set by INI file ?
                        objFlexDMDScene.Getimage("Image").Height = 32 'if release maybe set by INI file ?

                    Case ".wmv", ".mp4", ".avi", ".gif"
                        objFlexDMDScene.AddActor(objFlexDMD.NewVideo("Video", path))
                        objFlexDMDScene.GetVideo("Video").loop = True
                        objFlexDMDScene.GetVideo("Video").Width = 128 'if release maybe set by INI file ?
                        objFlexDMDScene.GetVideo("Video").Height = 32 'if release maybe set by INI file ?
